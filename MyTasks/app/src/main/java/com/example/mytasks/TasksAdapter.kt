...
class TasksAdapter (private var tasks: List<Task>, context: Context) : RecyclerView.Adapter<TasksAdapter.TaskViewHolder>() {
        ...
        class TaskViewHolder(taskView: View): RecyclerView.ViewHolder(taskView) {
                ...
                val taskView: TextView = itemView.findViewById(R.id.taskView)
        ...
        override fun onBindViewHolder(holder: TaskViewHolder, position: Int) {
                ...
                holder.taskView.text = task.content
                ...
                holder.deleteButton.setOnClickListener {
                        ...
                        Toast.makeText(holder.itemView.context, "Task Has Been Deleted", Toast.LENGTH_SHORT).show()
                }
